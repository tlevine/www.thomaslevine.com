---
title: R graphics magic that you probably shouldn't use
tweet_text1: Learn from my mistakes; don't use base R graphics!
tweet_text2: I understand neither how nor why people learn base R graphics.
---
```{r configure, echo = F}
opts_chunk$set(fig.width=10, fig.height=5, dpi = 42 * 5)
```
I've spent years of my life trying to make nice plots with base R
graphics. (I wish I'd found out about ggplot earlier.)

Anyway, I've learned a bunch of base R graphics tricks, so now
I'm going to show you my vague boilerplates for bar plots, strip
charts, and more complicated plots.

If you already use base R graphics a lot, you might pick up some
useful tricks. And if you haven't used base R graphics much,
maybe I'll just convince you not to start.
...
plot-configuration interface (through the grammar of graphics), so all
of those boilerplate plots would have been a rather simple sum of ggplot elements.

I try to use ggplot for most things these days, but I still use base
R graphics for [music videos](/music).
